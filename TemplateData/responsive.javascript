(function(){
    ...
    const unityContainer = q('#unityContainer');

    const initialDimensions = {width: parseInt(unityContainer.style.width, 10), height: parseInt(unityContainer.style.height, 10)};
    ...
    }).observe(unityContainer, {childList:true});
